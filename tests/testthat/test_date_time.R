...
test_that("as_str_datetime truncates correctly", {
  expect_equal(as_str_datetime(dttm_ymd), str_ymd)
  expect_equal(as_str_datetime(dttm_ymd_h), str_ymd_h)
  expect_equal(as_str_datetime(dttm_ymd_hm), str_ymd_hm)
  expect_equal(as_str_datetime(dttm_ymd_hms), str_ymd_hms)
})
...
test_that("as_str_datetime works with unix time", {
  expect_equal(as_str_datetime(num_ymd), str_ymd)
  expect_equal(as_str_datetime(num_ymd_h), str_ymd_h)
  expect_equal(as_str_datetime(num_ymd_hm), str_ymd_hm)
  expect_equal(as_str_datetime(num_ymd_hms), str_ymd_hms)
})
...
test_that("as_datetime works with strings", {
  expect_equal(as_datetime(str_ymd), dttm_ymd)
  expect_equal(as_datetime(str_ymd_h), dttm_ymd_h)
  expect_equal(as_datetime(str_ymd_hm), dttm_ymd_hm)
  expect_equal(as_datetime(str_ymd_hms), dttm_ymd_hms)
})
...
test_that("seq_dates works for all intervals", {
  expect_equal(seq_dates(202203080000, 202203080002, by = "30s"), seq_30s)
  expect_equal(seq_dates(2022030800, 2022030802, by = "30m"), seq_30m)
  expect_equal(seq_dates(2022030800, 2022030802, by = "1h"), seq_1h)
  expect_equal(seq_dates(2022030812, 2022031012, by = "1d"), seq_1d)
})

test_that("seq_dates throws error with unknown interval units", {
  expect_error(seq_dates(202203080000, 202203080002, by = "30a"))
  expect_error(seq_dates(2022030800, 2022030802, by = "30b"))
  expect_error(seq_dates(2022030800, 2022030802, by = "1l"))
  expect_error(seq_dates(2022030812, 2022031012, by = "1q"))
  expect_error(seq_dates(2022030812, 2022031012, by = "d"))
})
